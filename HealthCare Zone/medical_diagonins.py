...
# Test-2
print("predict label:",svc.predict(x_test.iloc[13].values.reshape(1,-1)))
print("Actual label:",y_test[13])

#Recommendation model

sys_des = pd.read_csv("Dataset/symtoms_df.csv")
precatataions = pd.read_csv("Dataset/precautions_df.csv")
workout = pd.read_csv("Dataset/workout_df.csv")
description = pd.read_csv("Dataset/description.csv")
medication = pd.read_csv("Dataset/medications.csv")
dites = pd.read_csv("Dataset/diets.csv")
...
def helper(dis):
    ...
    pre = precatataions[precatataions['Disease']==dis][['Precaution_1','Precaution_2','Precaution_3','Precaution_4']]
    pre = [col for col in pre.values]

    med = medication[medication['Disease'] == dis]['Medication']
    med = [med for med in med.values]

    die = dites[dites['Disease'] == dis]['Diet']
